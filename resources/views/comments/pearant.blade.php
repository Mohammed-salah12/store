...
@yield('content')
    ...
    <footer>
        <div class="row">
            ...
            <div class="single_footer">
                ...
                <ul>
                    ...
                    <li><a href="#"><i class="fas fa-chevron-right"></i> FQA</a></li>
        ...
        <div class="copy">
            Design For Free by &copy;
            <a href="https://www.youtube.com/channel/UCzcKCRrYGf1bQGMkRPhXfJw">Hussein Coder 2022</a>
        </div>
    </footer>
    <!-- Javascript Section -->
